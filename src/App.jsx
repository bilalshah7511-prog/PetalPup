    ...
    <>
      ...
      <header className="site-header">
        <div className="site-header__row">
          ...
          <a href="#" className="site-logo" aria-label="Petal & Pup">
            <img src={brand.logoSrc} alt="Petal & Pup" />
          </a>
      ...
      <div className={`mobile-menu${menuOpen ? ' is-open' : ''}`}>
        <div className="mobile-menu__body">
          ...
          <nav className="mobile-menu__nav">
            <a href="#" className="mobile-menu__nav-main">new</a>
            <a href="#" className="mobile-menu__nav-main">dresses</a>
            <a href="#" className="mobile-menu__nav-main">tops</a>
          </nav>
        </div>
      </div>
                ...
                <div className="pdp-sheet__options">
                  {product.colors.map((c) => (
                    <button
                      ...
                      aria-label={c.label}
                      aria-pressed={draftColorId === c.id}
                      title={c.label}
      ...
      <section className="product-section">
        ...
        <div className="product-info">
          ...
          <p className="product-subtitle">Playsuit · {selectedColor.label}</p>
